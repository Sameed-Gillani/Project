...
$enrollments = $pdo->query("
    SELECT enrollments.id, students.name AS student_name, courses.course_name, courses.instructor, enrollments.enrolled_at 
    FROM enrollments 
...
<head>
    <meta charset="UTF-8">
    <title>Enrollments - University Portal</title>
